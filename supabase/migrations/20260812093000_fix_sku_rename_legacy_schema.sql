-- Production installations created by early migrations may not have
-- v2_product_main.updated_at. Keep SKU renaming compatible with both schemas.
...
begin
  ...
  update public.v2_product_main set sku_code = v_new where sku_code = v_old;
